...
Canvas.registerFont(`${__dirname}/assets/fonts/SF-Pro.ttf`, { family: "SF-Pro" });
...
module.exports.Lickanime = require('./src/JXR/Lick');
module.exports.Burn = require('./src/JXR/Burn');
module.exports.Welcome = require('./src/greetings/Welcome');
module.exports.Verifycation = require('./src/greetings/Verifycation');
module.exports.Rank = require('./src/rank/Rank');
module.exports.Hacker1 = require('./src/JXR/Hacker1');
module.exports.Hacker2 = require('./src/JXR/Hacker2');
module.exports.Hacker3 = require('./src/JXR/Hacker3');
module.exports.Patrick = require('./src/JXR/Patrick');
...
module.exports.Attp = require('./src/update/Attp');
module.exports.Ttp = require('./src/update/Ttp');
//welcome
